...
contract GalactiCredit is Context, IERC20, Ownable {
    ...
    */
    ...
    function _takeDevFee(uint256 tDevFee) private {
        ...
        _rOwned[_devWalletAddress] = _rOwned[_devWalletAddress].add(rDevFee);
        if(_isExcluded[_devWalletAddress])
            _tOwned[_devWalletAddress] = _tOwned[_devWalletAddress].add(tDevFee);
    }
    */
